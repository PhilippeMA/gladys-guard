...
module.exports = function recVid() {
    return new Promise(function(resolve, reject) {
          ...
          var firstTime = false;
            ...
            gladys.param.getValues(['GUARD_LAST_REC', 'GUARD_REC_DURATION', 'GUARD_REC_DEVICE', 'GUARD_REC_LOCATION', 'GUARD_SAVE_LOCATION'])
              .then(function(params){

              lastRec = params[0];
              duree = params[1];
              device = params[2];
              recLocation = params[3];
              saveLocation = params[4];
