...
module.exports = function() {
	...
	// Emplacement de sauvegarde de la dernière vidéo enregistrée qui sera lue sur le dashboard
	gladys.param.setValue({name: 'GUARD_REC_LOCATION', value: '/home/pi/gladys/www/video/'});
